...
<head>
    ...
    <title>Customer Registration - Vice City Services</title>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="glass-card reveal">
                    <div class="text-center mb-4">
                        <div class="mb-3">
                            <i class="bi bi-person-plus-fill" style="font-size: 4rem; background: var(--primary-gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"></i>
                        </div>
                        <h1 class="hero-title" style="font-size: 2rem;">Join Us</h1>
                        <p class="hero-subtitle">Customer Registration</p>
                    </div>
                    ...
                    <form method="POST" action="" class="needs-validation" novalidate>
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-muted mb-0">
                                Are you an agency? 
                                <a href="register_agency.php" class="text-decoration-none fw-bold">Register as Agency</a>
                            </p>
                        </div>
                    </form>
                </div>
